...
const REPORT_CSS = `
:root{--purple:#5b2d90;--teal:#078b8f;--green:#13795b;--amber:#b7791f;--red:#b42318;--line:#94a3b8;--paper:#fff;--bg:#eef3f7;--text:#102033;--muted:#64748b}
...
.report-toolbar button{font:inherit;font-weight:800;border-radius:10px;padding:8px 14px;border:1px solid #c7d1df;background:#fff;color:var(--purple);cursor:pointer}
.report-toolbar button.primary{background:var(--purple);border-color:var(--purple);color:#fff}
...
.simple-table th{background:var(--purple);color:#fff;text-align:left;padding:6px 8px}
...
.appendix summary{font-weight:800;color:var(--purple);cursor:pointer}
